        ...
        <section className="footer p-6 rounded-xl shadow-md space-y-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside about space-y-1">
              ...
              <li>
                We may also use other tracking technologies (like scripts or similar) that have the same function as
                cookies (storing or accessing information on a device).
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside about space-y-1">
              ...
              <li>
                To monitor and analyze how users use our Website (traffic, page views, performance, errors), in order to
                improve the Website and our services.
              </li>
              <li>
                For security and fraud prevention (e.g., ensuring session integrity, preventing malicious activity).
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside about space-y-1">
              ...
              <li>
                If you consent, cookies beyond strictly necessary ones may be set (performance, preferences, analytics,
                etc.).
              </li>
