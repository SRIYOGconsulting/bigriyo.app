...
export default function Contact() {
  ...
  const handleSubmit = (e: React.SubmitEvent) => {
    ...
    if (!formData.email) console.log("Form submitted:", formData);
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-7">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-2.5 border  rounded text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent resize-none focus:bg-white"></textarea>
              </div>
