    ...
    <div className="min-h-screen ">
      ...
      <section className="max-w-7xl mx-auto py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 place-content-center place-items-center">
          <div className="flex flex-col justify-center items-center gap-3">
            <Image height={24} width={24} src="/vmgo/vision.png" alt="" className="w-24 h-24 " />
            <p>Vision</p>
          </div>
          <div className="flex flex-col justify-center items-center gap-3">
            <Image height={24} width={24} src="/vmgo/mission.png" alt="" className="w-24 h-24 " />
            <p>Mission</p>
          </div>
          <div className="flex flex-col justify-center items-center gap-3">
      ...
      <section id="vision" className="flex justify-between gap-24 mb-12 py-8 max-w-5xl mx-auto">
        <div className="hidden md:flex items-center mb-6 ">
          <Image height={600} width={800} src="/vmgo/vision.png" alt="" className="w-auto h-40 text-teal-700 " />
        </div>
        <div className="p-8 md:p-16 card space-y-4 max-w-3xl rounded-xl">
          <h2 className="text-3xl font-bold text">Vision</h2>
          <p className=" text-md leading-relaxed mb-4">
            Our vision at SRIYOG is to create a future where every individual has access to opportunities that match
            their skills and aspirations.{" "}
          </p>
          <p className=" text-md leading-relaxed">
            We envision a world where people searching for any service can easily connect with skilled professionals
            rather than hiring hefty commission from any service marketplace, and where an individual can have his/her
            digital profile showcasing their expertise.
          </p>
        </div>
      </section>
      ...
      <section id="mission" className="flex justify-between gap-24 mb-12  max-w-5xl mx-auto">
        <div className="p-8 md:p-16 bg-teal-700 text-white space-y-4 max-w-3xl rounded-xl ">
          ...
          <p className="text-md leading-relaxed ">
            At SRIYOG, our mission is to revolutionize the way work is connected with workers. We strive to provide a
            seamless platform that empowers individuals and businesses to find the perfect match for their needs,
            fostering opportunities for growth, collaboration, and success.{" "}
          </p>
        </div>
        <div className="hidden md:flex items-center mb-6">
          <Image height={600} width={800} src="/vmgo/mission.png" alt="" className="w-auto h-40 " />
        </div>
      </section>
