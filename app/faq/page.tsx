...
const faqs = [
  ...
  },
  {
    ...
    answer: "SRIYOG Consulting serves a broad range of industries, including healthcare, employment and tourism."
  },
  {
    id: 5,
    question: "Who is the CTO of SRIYOG Consulting?",
    answer: "Prakash Upreti, also known as PRACAS, is the Chief Technology Officer of SRIYOG Consulting."
  },
  {
    id: 6,
  ...
  },
  {
    ...
    answer: "It involves monthly strategy, content creation, engagement, and analytics to enhance digital branding."
  },
  {
    id: 9,
    question: "What does the database/ web server rental service offer?",
    answer: "It provides secure server space for hosting websites, databases, and applications."
  },
  {
    id: 10,
    question: "What does the mobile app development service entail?",
    answer: "Development of professional mobile apps tailored to client needs, compatible with Android and iOS."
  },
  {
    id: 11,
    question: "What kind of websites does SRIYOG Consulting develop?",
    answer: "We build custom, user-friendly websites including e-commerce, CMS, and SaaS applications."
  },
  {
    id: 12,
  ...
  },
  {
    ...
    answer: "Yes, SSL certification, security audits, and cyber protection are part of our cloud services."
  },
  {
    id: 15,
    question: "What analytics services are offered?",
    answer: "Data analysis, survey form development, and insights to improve business decision-making."
  },
  {
    id: 16,
  ...
  },
  {
    ...
    answer: "Clients include Magic Footwear, Trans Nepal, PUSOM, Neuro Hospital, CVDS Nepal, and more."
  },
  {
    id: 18,
    question: "What is the mission of SRIYOG Consulting?",
    answer: "To empower businesses with reliable IT solutions that streamline operations and drive growth."
  },
  {
    id: 19,
    question: "What is the vision of SRIYOG Consulting?",
    answer: "To be a leading IT consulting firm in Nepal and globally through innovation and strategic partnerships."
  },
  {
    id: 20,
  ...
  },
  {
    ...
    answer: "Yes, we do. The intakes are on June-August, September-November, December-February, March-May."
  },
  {
    id: 22,
